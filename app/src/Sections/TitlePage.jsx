...
export default function TitlePage() {
    return (
        <>
        <main className="bg-slate-900 w-screen h-[95vh] overflow-hidden md:flex-row flex-col flex items-start">
            <section className="flex flex-col items-start">
                ...
                <section className=" flex justify-center mt-18 w-full">
                    <button className="w-auto h-auto bg-blue-800 text-2xl text-white font-bold px-6 py-4 rounded-lg hover:bg-blue-700 hover:cursor-pointer transition-colors duration-200">Get started!</button>
                </section>
            </section>
            <section className="flex-col items-end md:flex m-3">
                <section className="grid grid-cols-1 md:grid-cols-2 w-[100%] md:w-[80%] gap-4 place-content-center">
        ...
        <footer className="w-screen h-[5vh] py-2 bg-gray-800 flex items-center">
